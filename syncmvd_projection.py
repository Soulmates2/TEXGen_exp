...
if __name__ == "__main__":
    ...
    for config_path in config_path_list:
        ...
        cmd += f" --output {SyncMVD_path}/output_debug"
    ...
    for i, cmd in enumerate(cmd_list):
        ...
        shutil.copy(f"{SyncMVD_path}/output/{model_id}/results/textured.png", \
                    f"/home/dld/texture/TEXGen/assets/models_final/{model_id[:2]}/{model_id}/model.png")
